...
Source0  : https://files.pythonhosted.org/packages/7d/19/fecb7e2825616270f34512b3394cdcf6f45a79b5b6d94fdbd86a509e67b5/setuptools-79.0.0.tar.gz
...
%prep
%setup -q -n setuptools-79.0.0
cd %{_builddir}/setuptools-79.0.0
pushd ..
cp -a setuptools-79.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745245292
