...
Source0  : https://files.pythonhosted.org/packages/67/ba/27235b9eebee2492fbf03ac1828a997d3d686031445d491f9cfa36a7085e/setuptools-66.0.0.tar.gz
...
%prep
%setup -q -n setuptools-66.0.0
cd %{_builddir}/setuptools-66.0.0
pushd ..
cp -a setuptools-66.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673892890
