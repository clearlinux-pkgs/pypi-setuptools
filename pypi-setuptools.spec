...
Source0  : https://files.pythonhosted.org/packages/a9/5a/0db4da3bc908df06e5efae42b44e75c81dd52716e10192ff36d0c1c8e379/setuptools-78.1.0.tar.gz
...
%prep
%setup -q -n setuptools-78.1.0
cd %{_builddir}/setuptools-78.1.0
pushd ..
cp -a setuptools-78.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743001431
