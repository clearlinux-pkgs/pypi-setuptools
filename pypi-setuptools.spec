...
Version  : 66.1.0
Release  : 287
URL      : https://files.pythonhosted.org/packages/34/4d/5c3547ed1dd4cb8623ec6843a49a6a0598b37ec5358551e84b97bc4f5ee8/setuptools-66.1.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/34/4d/5c3547ed1dd4cb8623ec6843a49a6a0598b37ec5358551e84b97bc4f5ee8/setuptools-66.1.0.tar.gz
...
%prep
%setup -q -n setuptools-66.1.0
cd %{_builddir}/setuptools-66.1.0
pushd ..
cp -a setuptools-66.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674229952
