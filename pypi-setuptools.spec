...
Source0  : https://files.pythonhosted.org/packages/fb/50/005826d31d58a7b90585b5510f2f597c5406ae34df884f4f5d63abfb6ca7/setuptools-62.3.3.tar.gz
...
%prep
%setup -q -n setuptools-62.3.3
cd %{_builddir}/setuptools-62.3.3
%patch1 -p1
pushd ..
cp -a setuptools-62.3.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656373628
...
cp %{_builddir}/setuptools-62.3.3/LICENSE %{buildroot}/usr/share/package-licenses/pypi-setuptools/8e6689d37f82d5617b7f7f7232c94024d41066d1
