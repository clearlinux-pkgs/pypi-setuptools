...
Source0  : https://files.pythonhosted.org/packages/43/54/292f26c208734e9a7f067aea4a7e282c080750c4546559b58e2e45413ca0/setuptools-75.6.0.tar.gz
...
%prep
%setup -q -n setuptools-75.6.0
cd %{_builddir}/setuptools-75.6.0
pushd ..
cp -a setuptools-75.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732138760
