...
Source0  : https://files.pythonhosted.org/packages/a3/56/f49e7877e8d8a09faaeecde5ca61169e9cfd46d014def474daa31bf217ca/setuptools-67.3.2.tar.gz
...
%prep
%setup -q -n setuptools-67.3.2
cd %{_builddir}/setuptools-67.3.2
pushd ..
cp -a setuptools-67.3.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676517210
