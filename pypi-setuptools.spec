...
Source0  : https://files.pythonhosted.org/packages/95/d0/fdd5d7386308b1b05dbcf7a8c9315379ac8a6187c4171d936d9a506f1428/setuptools-64.0.1.tar.gz
...
%prep
%setup -q -n setuptools-64.0.1
cd %{_builddir}/setuptools-64.0.1
pushd ..
cp -a setuptools-64.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660265019
