...
Source0  : https://files.pythonhosted.org/packages/3c/7b/00030a938499c8f8345be02ab5b7d748d359ea59c2f020b7b0a21b82f832/setuptools-66.1.1.tar.gz
...
%prep
%setup -q -n setuptools-66.1.1
cd %{_builddir}/setuptools-66.1.1
pushd ..
cp -a setuptools-66.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674259852
