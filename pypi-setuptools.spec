...
Source0  : https://files.pythonhosted.org/packages/5b/ff/69fd395c5237da934753752b71c38e95e137bd0603d5640df70ddaea8038/setuptools-63.4.3.tar.gz
...
%prep
%setup -q -n setuptools-63.4.3
cd %{_builddir}/setuptools-63.4.3
pushd ..
cp -a setuptools-63.4.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660167212
