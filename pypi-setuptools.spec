...
Source0  : https://files.pythonhosted.org/packages/fe/db/68d856066c59bd9f05e827c3cf80164d870b8b6af37dc5ad6c87a71d20f2/setuptools-67.0.0.tar.gz
...
%prep
%setup -q -n setuptools-67.0.0
cd %{_builddir}/setuptools-67.0.0
pushd ..
cp -a setuptools-67.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674944186
