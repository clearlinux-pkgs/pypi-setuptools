...
Source0  : https://files.pythonhosted.org/packages/4c/f4/aa8d364f0dc1f33b2718938648c31202e2db5cd6479a73f0a9ca5a88372d/setuptools-78.0.2.tar.gz
...
%prep
%setup -q -n setuptools-78.0.2
cd %{_builddir}/setuptools-78.0.2
pushd ..
cp -a setuptools-78.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742913846
...
cp %{_builddir}/setuptools-%{version}/setuptools/_vendor/packaging-24.2.dist-info/LICENSE.APACHE %{buildroot}/usr/share/package-licenses/pypi-setuptools/598f87f072f66e2269dd6919292b2934dbb20492 || :
cp %{_builddir}/setuptools-%{version}/setuptools/_vendor/packaging-24.2.dist-info/LICENSE.BSD %{buildroot}/usr/share/package-licenses/pypi-setuptools/fdc0e4eabc45522b079deff7d03d70528d775dc0 || :
...
cp %{_builddir}/setuptools-%{version}/setuptools/config/_validate_pyproject/NOTICE %{buildroot}/usr/share/package-licenses/pypi-setuptools/44cb3d1c29600408cf794c72ee9ec2fec320d623 || :
...
/usr/share/package-licenses/pypi-setuptools/44cb3d1c29600408cf794c72ee9ec2fec320d623
