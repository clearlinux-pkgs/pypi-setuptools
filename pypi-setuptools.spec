...
Source0  : https://files.pythonhosted.org/packages/4a/25/ec29a23ef38b9456f9965c57a9e1221e6c246d87abbf2a31158799bca201/setuptools-62.3.2.tar.gz
...
%prep
%setup -q -n setuptools-62.3.2
cd %{_builddir}/setuptools-62.3.2
%patch1 -p1
pushd ..
cp -a setuptools-62.3.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654262981
