...
Source0  : https://files.pythonhosted.org/packages/99/61/f3b6c920f0e187368f4eeb57a7255afb428926beefba33f05f16214e66bb/setuptools-59.7.0.tar.gz
...
%prep
%setup -q -n setuptools-59.7.0
cd %{_builddir}/setuptools-59.7.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642547427
...
cp %{_builddir}/setuptools-59.7.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-setuptools/8e6689d37f82d5617b7f7f7232c94024d41066d1
